...
model_path = r'C:\Users\alex_\.cache\lm-studio\models\TheBloke\CodeLlama-70B-Python-GGUF\codellama-70b-python.Q5_K_M.gguf'
## Instantiate model from downloaded file
llm = Llama(
    model_path=model_path,
    n_gpu_layers=32, n_threads=32, n_ctx=3584, n_batch=521, mlock=True, use_cuda=True
)
